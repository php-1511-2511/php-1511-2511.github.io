...
2. Create two plots, one for each treatment group, showing the trajectories of each subject’s grip strength over time. Comment on the notable features in these trajectories.
