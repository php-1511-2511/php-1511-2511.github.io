...
- To explore this more we will consider a new data example with a subset of data from the [Phsyicians Health Study](http://phs.bwh.harvard.edu/). 
...
```{R, echo=F}
library(broom)
knitr::kable(tidy(mod2, conf.int=T)[,-c(3:4)])
```
