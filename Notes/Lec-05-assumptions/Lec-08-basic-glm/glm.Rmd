...
----------------------------------------------------------------------------------
 Random             Link              Outcome       Explanatory
Component         Function             Variable       Variable        Model
-------------  --------------------  ---------------  --------------  -----------------------
   Normal       Indentity             Continuous      Factor          ANOVA
   
   Normal       Indentity             Continuous      Continuous      Regression  
...
$$logit\left(\dfrac{p}{1-p}\right) = \beta_0 + \beta_1x_1$$
$$\text{or}$$
$$logit\left(\dfrac{p}{1-p}\right) = \beta_0 + \beta_1x_1 + \cdots + \beta_px_p$$
