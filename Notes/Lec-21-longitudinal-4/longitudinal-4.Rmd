...
$$Var(Y_{ij}) = Var(b_i) + Var(\varepsilon_{ij}) = \sigma^2_b + \sigma^2$$
...
$$Cov(Y_{ij}, Y_{ik}) = \sigma^2_b\qquad \Rightarrow \qquad Corr(Y_{ij}, Y_{ik}) = \dfrac{\sigma^2_b}{\sigma^2_b + \sigma^2}$$
